...
<head>
    ...
    <title>SPK Rekomendasi Hotel</title>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
                ...
                <h1 class="sitename">SPK Rek Hotel</h1>
            </a>

            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="<?=base_url('pages')?>#hero">Beranda</a></li>
                    <li><a href="<?=base_url('pages')?>#recent-posts">Hotel</a></li>
                    <li><a class="<?=$menu == 'rekomendasi'?'active':''?>"
                            href="<?=base_url('pages/rekomendasi')?>">Rekomendasi</a></li>
                    <li><a href="<?=base_url('pages')?>#contact">Kontak Kami</a></li>
                </ul>
